<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8">
          ...
          <title>Nội thất Hà Nội | Thống kê hóa đơn</title>
  ...
  <style type="text/css">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thống kê hóa đơn</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="container">
          ...
          <table class="table table-bordered mt-3 .bg-light">
            ...
            <?php
                ...
                $query=mysqli_query($conn,"SELECT * FROM tblorderdetails LIMIT $perRow, $rowsPerPage");
                $totalRows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tblorderdetails"));
